...
class PickAndPlaceBrain(UR12eController):
    ...
    def set_gripper(self, position):
        ...
        try:
            # 0x0900 (Activate+GoTo), Position, 0x6432 (Speed 100, Force 50)
    ...
    def check_stability(self):
        ...
        if self.latest_pose.position.x == 0.0: return False
    ...
    def execute_move(self):
        ...
        try:
            ...
            self.get_logger().info(f"Picking {self.target_class} at Theta: {math.degrees(theta):.1f}")
...
def main(args=None):
    ...
    # Wait for the activation sweep to finish
    if brain.gripper_connected:
        print("Waiting 4s for gripper sweep...")
        time.sleep(4.0)
